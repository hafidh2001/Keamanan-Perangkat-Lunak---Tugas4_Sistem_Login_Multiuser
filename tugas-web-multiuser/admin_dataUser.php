...
//QUERY :
$data_user = query("SELECT * FROM tb_user WHERE level = 'FREE' OR level = 'PREMIUM' ORDER BY created_at DESC LIMIT $awalData, $jumlahDataPerHalaman");
?>
...
<head>
    ...
    <title>Admin_DataUser | HF-Cascade</title>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($data_user as $du) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $du["email"]; ?></td>
                                    <td><?= $du["username"]; ?></td>
                                    <td><?= $du["verification"]; ?></td>
                                    <td><?= $du["level"]; ?></td>
                                    <td><?= $du["created_at"]; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#upgrade-user">
                                            Upgrade
                                        </button>
